...
class GetDirAudioByIdService(IService):
    def __init__(self, core, parameters):
        super(GetDirAudioByIdService, self).__init__(core, parameters)
    ...
    def run(self):
        ...
        if _id != '0':
            name = _id + self.core.InternalOperation("getFileTypeService",{"type":"audio","ext":"mp3"})

        mime = "audio/mp3" #Default MIME
        try:
